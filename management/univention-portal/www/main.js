...
define([
	...
	return {
		...
		start: function() {
			...
			// document.getElementById('portal').appendChild(portal.domNode);
			// portal.startup();
			// document.getElementById('portal').replaceWith(portal.domNode);
		},
