...
define([
	...
	"umc/widgets/Text",
	"umc/widgets/Button",
	"login", // TODO check if weirdness with circular require
	"umc/i18n!",
], function(declare, lang, array, on, Deferred, topic, tap, domClass, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, DijitMenuItem, PopupMenuItem, MenuSeparator, tools, MenuItem, SubMenuItem, _Button, ContainerWidget, Text, umcButton, login, _) {
	...
	var LoginHeader = declare('LoginHeader', [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		...
		templateString: `
			<div class="menuLoginHeader">
				<div
					class="menuLoginHeader--loggedout"
					data-dojo-attach-point="loginWrapper"
				>
					<button
						class="ucsTextButton"
						data-dojo-type="umc/widgets/Button"
						data-dojo-attach-point="loginButon"
					></button>
				</div>
				<div
					class="menuLoginHeader--loggedin dijitDisplayNone"
					data-dojo-attach-point="loggedinWrapper"
				>
					<div
						class="menuLoginHeader__logo"
					></div>
					<div class="menuLoginHeader__innerWrapper">
						<div
							class="menuLoginHeader__username"
							data-dojo-attach-point="usernameNode"
						></div>
						<button
							class="menuLoginHeader__logoutButton ucsTextButton"
							data-dojo-type="umc/widgets/Button"
							data-dojo-attach-point="logoutButon"
						></button>
					</div>
				</div>
			</div>
